...
public final class ExportExcel {
     ...
     *        sheet名称和表头值
     */
    public static void excelExport(List<?> dataList, Map<String, String> titleMap, String sheetName, HttpServletRequest request, HttpServletResponse response) {
        // 初始化workbook
        ...
        try {
            ...
            response.reset();
            //避免中文乱码
            response.setHeader("Content-Disposition", "attachment;filename=" + new String(filedisplay.getBytes(), StandardCharsets.ISO_8859_1));
            ...
            for (Object obj : dataList) {
                ...
                for (String entry : titleMap.keySet()) {
                    ...
                    if(m.invoke(obj, null)!=null) {
                        Object obj1 =  m.invoke(obj, null);
                        if(obj1 instanceof  Date){
                            value = sdf.format((Date)obj1);
                        }else{
                            value = obj1.toString();
                        }
                    }
