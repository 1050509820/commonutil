...
public class QRCodeUtil {
    ...
    public static void main(String[] args) {
        try {
            String text = "18669091656";
            String destPath =Class.class.getClass().getResource("/").getPath()+"/upload";
            String filename="18669091656";
            String str =QRCodeUtil.encode(text, null, destPath, filename, true);
            str = QRCodeUtil.decode("d:\\"+str);
